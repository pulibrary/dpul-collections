defmodule DpulCollectionsWeb.ItemLiveMetadataTest do
  ...
  setup do
    Solr.add(
      [
        %{
          id: 1,
          summary_txtm: ["A series of paintings of wizards", "ink and watercolor"],
  ...
  test "/item/{:id}/metadata displays all the metadata fields and has links for linkable fields",
    ...
    assert view |> has_element?("h2", "Item Summary")
    ...
    assert view |> has_element?("a[href='/search?filter%5Bcreator%5D%5B%5D=Bifur']")
    assert view |> has_element?("dt", "Contributor")
    assert view |> has_element?("a[href='/search?filter%5Bcontributor%5D%5B%5D=Bombur']")
    ...
    assert view |> has_element?("a[href='/search?filter%5Bpublisher%5D%5B%5D=Elrond']")
    assert view |> has_element?("dt", "Language")
    assert view |> has_element?("dd", "Common")
    assert view |> has_element?("a[href='/search?filter%5Blanguage%5D%5B%5D=Common']")
    assert view |> has_element?("dd", "Elvish")
    assert view |> has_element?("dt", "Date Created")
    assert view |> has_element?("dd", "Durin")
    assert view |> has_element?("a[href='/search?filter%5Bdate%5D%5B%5D=Durin']")
    assert view |> has_element?("dt", "Format")
    assert view |> has_element?("dd", "Paintings")
    assert view |> has_element?("a[href='/search?filter%5Bformat%5D%5B%5D=Paintings']")
    ...
    assert view |> has_element?("a[href='/search?filter%5Brights_statement%5D%5B%5D=Copyright']")
    assert view |> has_element?("dt", "Subject")
    assert view |> has_element?("dd", "Magic")
    assert view |> has_element?("a[href='/search?filter%5Bsubject%5D%5B%5D=Magic']")
    assert view |> has_element?("dt", "Geographic Subject")
    assert view |> has_element?("dd", "Mordor")
    assert view |> has_element?("a[href='/search?filter%5Bgeo_subject%5D%5B%5D=Mordor']")
    ...
    assert view |> has_element?("a[href='/search?filter%5Bgeographic_origin%5D%5B%5D=Mountains']")
    ...
    assert view |> has_element?("a[href='/search?filter%5Bcollection%5D%5B%5D=Things']")

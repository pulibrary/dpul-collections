defmodule DpulCollections.SolrTest do
  ...
  setup context do
    ...
    if cache_settings = context[:cache_settings] do
      ...
      on_exit(fn -> Application.delete_env(:dpul_collections, DpulCollections.IndexingPipeline) end)
    end
  ...
  test "document_count_report" do
   ...
   assert Solr.document_count_report == [%{cache_version: 1, collection: "dpulc1", document_count: 2}, %{cache_version: 2, collection: "dpulc2", document_count: 1}]

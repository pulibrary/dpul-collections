defmodule DpulCollections.SolrTest do
  ...
  describe ".random_recommended_from_items/1" do
    test "returns a random subset of similar items from all the given items" do
      docs_first_item = [
        %{
          "id" => "reference",
          "title_txtm" => ["test title 1"],
          "genre_txtm" => ["pamphlets"],
          "subject_txtm" => ["folk art", "museum exhibits", "athletics"],
      ...
      docs_second_item = [
        %{
          ...
          "genre_txtm" => ["books"],
          "subject_txtm" => ["cats", "dogs", "athletics"],
          "ephemera_project_title_s" => "Latin American Ephemera"
        },
        %{
          "id" => "similar_to_2",
          "title_txtm" => ["similar item to 2"],
          "genre_txtm" => ["books"],
          "subject_txtm" => ["cats", "music"],
          "ephemera_project_title_s" => "Latin American Ephemera"
        },
        %{
          "id" => "less-similar-to-2",
          "title_txtm" => ["item that's not as similar to 2"],
          "genre_txtm" => ["books"],
          "subject_txtm" => ["bananas", "oranges"],
          "ephemera_project_title_s" => "Latin American Ephemera"
        }
      ]

      Solr.add(docs_first_item ++ docs_second_item, active_collection())
      Solr.commit(active_collection())

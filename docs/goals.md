...
### Collection page
- Draw a user deeper into the collection
- Empower users to answer the question, "Do I want to explore these resources?"
- Evoke intriguing (50%) yet informative (50%)
- Evoke dynamic (75%) yet grounded (25%)
- Evoke approachable (75%) yet reputable (25%)

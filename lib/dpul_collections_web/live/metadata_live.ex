defmodule DpulCollectionsWeb.MetadataLive do
  ...
  def render(assigns) do
    ...
    <div class="header-x-padding page-y-padding bg-accent flex flex-row">
      <h1 class="uppercase text-light-text">Metadata</h1>
    </div>
    <div class="main-content header-x-padding page-y-padding">
      <div class="py-6">
        <h2 class="border-t-1 border-accent py-3">Item Description</h2>
      ...
      >
        <div
          ...
          <h2 class="border-t-1 border-accent py-3">{category}</h2>
          </div>

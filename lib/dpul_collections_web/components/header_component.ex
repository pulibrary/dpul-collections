...
defmodule DpulCollectionsWeb.HeaderComponent do
    ...
    def header(assigns) do
      ...
      <header class="flex flex-row gap-10 items-center bg-gray-700 py-10 px-8 lg:px-10">
            ...
            <div class="app_name flex-1 text-2xl group text-white">
                <.link navigate={~p"/"} class="group-hover:underline group-hover:decoration-orange-500 group-hover:decoration-2">
                    DPUL Collections
                </.link>
            </div>

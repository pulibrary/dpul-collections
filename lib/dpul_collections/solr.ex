defmodule DpulCollections.Solr do
  ...
  def mlt_focus(%{filter: %{"similar" => id}}) do
    "{!mlt qf=genre_txt_sort,subject_txt_sort,geo_subject_txt_sort,geographic_origin_txt_sort,language_txt_sort,keywords_txt_sort,description_txtm mintf=1 mindf=1}#{id}"
  end

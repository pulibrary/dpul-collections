defmodule DpulCollections.IndexingPipeline.FiggyTransformer do
  @moduledoc """
  Broadway consumer that demands FiggyHydrationCacheEntry records, transforms
  ...
  alias DpulCollections.IndexingPipeline.{TransformationCacheEntry, FiggyHydrationCacheEntry}
  use Broadway
  ...
  @spec handle_message(any(), %Broadway.Message{data: FiggyHydrationCacheEntry.t()}, %{
  ...
  @spec transform_to_solr_document(%FiggyHydrationCacheEntry{}) :: %{}
